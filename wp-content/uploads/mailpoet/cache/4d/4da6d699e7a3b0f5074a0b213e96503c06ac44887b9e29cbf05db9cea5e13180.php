...
class __TwigTemplate_a25145d62315ad72e94417a51fa5d85c0786b83afcb06b045ca3796d4b274907 extends \MailPoetVendor\Twig\Template
{
  ...
  <textarea placeholder=\"{{#if params.label_within}}{{ params.label }}{{#if params.required}} *{{/if}}{{/if}}\" disabled=\"disabled\" rows=\"{{#if params.lines}}{{ params.lines }}{{else}}1{{/if}}\">{{ params.text }}</textarea>
    ...
    {
        return new Source("", "form/templates/blocks/textarea.hbs", "/home/kojejefryl/www/fabulle/wp-content/plugins/mailpoet/views/form/templates/blocks/textarea.hbs");
    }
}
