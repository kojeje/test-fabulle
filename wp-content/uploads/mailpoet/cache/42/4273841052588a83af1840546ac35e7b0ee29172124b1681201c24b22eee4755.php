...
class __TwigTemplate_0d12e091ae99678cef298a9a2d7dee1031784bc5ba92ee422c7643a98bee2094 extends \MailPoetVendor\Twig\Template
{
...
<input type=\"text\" disabled=\"disabled\" value=\"\" placeholder=\"{{#if params.label_within}}{{ params.label }}{{#if params.required}} *{{/if}}{{/if}}\" />";
    ...
    {
        return new Source("", "form/templates/blocks/text.hbs", "/home/kojejefryl/www/fabulle/wp-content/plugins/mailpoet/views/form/templates/blocks/text.hbs");
    }
}
